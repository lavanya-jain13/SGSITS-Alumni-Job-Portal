...
const ContributorCard = ({ person, isHead = false, isManager = false }) => {
  ...
  let roleIcon = (
    <Briefcase className="w-4 h-4 mr-1 text-gray-400 dark:text-gray-500" />
  );
  ...
  if (isHead) {
    ...
    roleIcon = (
      <Users className="w-4 h-4 mr-1 text-blue-500 dark:text-cyan-400" />
    );
  ...
  return (
    ...
    <Card
      className={`h-full border-t-4 shadow-lg dark:shadow-blue-900/20 bg-white dark:bg-gray-900 
    ...
    >
      <CardContent className="pt-8 flex flex-col items-center text-center gap-4">
        ...
        <div
          className={`w-28 h-28 rounded-full overflow-hidden flex items-center justify-center border-4 border-white dark:border-gray-900 shadow-xl 
        ...
        <div className="space-y-1">
          ...
          <p
            className={`text-sm flex items-center justify-center ${roleColor}`}
          >
            {roleIcon}
            {person.role}
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-4xl mx-auto">
              We extend our sincere gratitude to the dedicated team of mentors
              and developers who brought the SGSITS Alumni Portal to life.
            </p>
          </div>
          ...
          <section className="space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 text-center">
                The talented developers responsible for coding and platform
                execution.
              </p>
            </div>
